...
import static tool.WriteVO.voToStr;
import static tool.WriteVO.writeVOToLocal;
...
public class Main {
    ...
    public static void printTime(int round, int keywordSize, HashMap<Integer, List<Integer>> allForwardIndex, DO dataOwner, SP serviceProvider) {
        ...
        System.out.println("查询时间：" + (sumQuery / l) / 1000000 + "ms" + "," + "验证时间：" + (sumVerify / l) / 1000000 + "ms" + "," + "VO大小：" + (sumVOSize / l) / 1024 + "kb");
    }
    public static queryAndVerifyRes queryAndVerifyTime(long[] queryRequest, DO dataOwner, SP server) {
        long startTime = System.nanoTime();
        SearchOutput searchOutput = server.MultiKeywordQuery(queryRequest);
        long endTime = System.nanoTime();
        System.out.println(Arrays.toString(searchOutput.result.toArray()));

        //验证
        long startTime1 = System.nanoTime();
        boolean isPass = dataOwner.verifyVO(searchOutput);
        System.out.println(isPass);
        long endTime1 = System.nanoTime();
        long size = writeVOToLocal(voToStr(searchOutput));
        queryAndVerifyRes queryAndVerifyRes = new queryAndVerifyRes((endTime - startTime), (endTime1 - startTime1), size, isPass);
    ...
    public static void main(String[] args) throws Exception {
        test(2000, 100000);
//        test("D:\\mycode\\mywork\\Dataset_processing\\test_dataset\\invertedIndex20000id2000keyword.txt");
//        System.out.println("--------------------------------------------");
//        test("D:\\mycode\\mywork\\Dataset_processing\\test_dataset\\invertedIndex40000id2000keyword.txt");
//        System.out.println("--------------------------------------------");
//        test("D:\\mycode\\mywork\\Dataset_processing\\test_dataset\\invertedIndex60000id2000keyword.txt");
//        System.out.println("--------------------------------------------");
//        test("D:\\mycode\\mywork\\Dataset_processing\\test_dataset\\invertedIndex80000id2000keyword.txt");
//        System.out.println("--------------------------------------------");
//        test("D:\\mycode\\mywork\\Dataset_processing\\test_dataset\\invertedIndex100000id2000keyword.txt");
//
//        test("D:\\mycode\\mywork\\Dataset_processing\\test_dataset\\invertedIndex20000id2000keyword_Uniform_new_k2000.txt");
//        System.out.println("--------------------------------------------");
//        test("D:\\mycode\\mywork\\Dataset_processing\\test_dataset\\invertedIndex40000id2000keyword_Uniform_new_k2000.txt");
//        System.out.println("--------------------------------------------");
//        test("D:\\mycode\\mywork\\Dataset_processing\\test_dataset\\invertedIndex60000id2000keyword_Uniform_new_k2000.txt");
//        System.out.println("--------------------------------------------");
//        test("D:\\mycode\\mywork\\Dataset_processing\\test_dataset\\invertedIndex80000id2000keyword_Uniform_new_k2000.txt");
//        System.out.println("--------------------------------------------");
//        test("D:\\mycode\\mywork\\Dataset_processing\\test_dataset\\invertedIndex100000id2000keyword_Uniform_new_k2000.txt");
    }


    public static void test(int keywordSize, int idSize) throws Exception {

        CGen KEY = new CGen(3);
        //DO
        String sk = "8155200";
//        for(int n = 2;n <= 10;n = n + 2){
        String path = "D:\\mycode\\mywork\\Dataset_processing\\test_dataset\\invertedIndex" + idSize + "id" + keywordSize + "keyword.txt";
        String forwardPath = "D:\\mycode\\mywork\\Dataset_processing\\test_dataset\\forwardIndex" + idSize + "id" + keywordSize + "keyword.txt";

//        HashMap<Integer, List<Integer>> allForwardIndex = readForwardData(forwardPath);
        DO dataOwner = new DO(path, forwardPath, sk, KEY);
//        SP serviceProvider = new SP(dataOwner.insertInformation, dataOwner.rootCommitment);
